...
class BookMarkController extends Controller
{
    ...
    public function index()
    {
        ...
        return response()->json(['success' => $user->bookmarkedBooks()->with(['author','category','image'])->get(['title','author.name','description','image.path','category.name','bookmark_type_id'])], 201);
    }
