...
class BookMarkController extends Controller
{
    ...
    public function index()
    {
        ...
        return response()->json(['success' => $user->bookmarkedBooks()->with(['author','category','image'])->get(['author_id', 'category_id', 'title', 'bookmark_type_id', 'image_path', 'description', 'id'])], 201);
    }
