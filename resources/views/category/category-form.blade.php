...
@section('content')
    <div class="toolbar py-5 py-lg-15" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            <h3 class="text-white fw-bolder fs-2qx me-5">{{ $category ? 'تعديل' : 'اضافة' }} تصنيف</h3>
                            ...
                            <form method="POST" action="{{ route('category.store',['category'=>$category?->id]) }}">
                                ...
                                <div class="image-input">
                                    ...
                                    <div class="image-input-preview"
                                         style="background-image:url({{ $category?->image ? "storage/images/" . $category->image->path : '/assets/images/placeholder.jpg' }})">
                                    </div>
