...
<nav class="navbar navbar-expand-lg navbar-light bg-dark " id="nav">
    ...
    <a class="font-semibold navbar-brand text-white d-flex gap-2" href="/dashboard"> <img src="{{ asset('images/riwaya.jpg') }}" width="50" class="rounded-full ">Riwaya</a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
    </button>

    <div class="collapse navbar-collapse " id="navbarSupportedContent">
        <ul class="flex lg:gap-5 mr-auto navbar-nav ">
            @guest
            <li class="nav-item active">
                <a class="nav-link text-white" href="/login-register">Login <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
