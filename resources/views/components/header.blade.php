    ...
    <div class="w-full bg-center bg-cover" style="height:32rem; background-image: url({{ asset('images/riwaya2.jpg') }} ); height: 100vh;">
        <div class="flex items-center justify-center w-full h-full bg-gray-900 bg-opacity-50">
            <div class="text-center">
                ...
                <button class="px-4 py-2 mt-4 text-sm font-medium text-white uppercase bg-blue-600 rounded hover:bg-blue-500 focus:outline-none focus:bg-blue-500">Start project</button>
            </div>
        </div>
    </div>
</header>
